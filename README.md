...
This is a work in progress ETL pipeline for visualizing pollen forecast data from [the EU Copernicus programme](https://atmosphere.copernicus.eu/). The pipeline is deployed on Azure and you can see outputs live at [http://www.pollencast.eu/](http://www.pollencast.eu/), with updates once per day!!
